...
SauceDemo Login | ErrorMessageContainer | .error-message-container | css | 2026-01-10 | Error validation element, only visible on failed login. Verified via browser evaluation.
```